...
[`07-z21-command-stations.md`](../../loconet-adapter/07-z21-command-stations.md).
...
BigFred runbook — see
[`07-z21-command-stations.md` §7.5](../../loconet-adapter/07-z21-command-stations.md#75-dual-protocol-centrals-best-effort).
...
| Document | Topic |
|----------|-------|
| [`loconet-adapter/07-z21`](../../loconet-adapter/07-z21-command-stations.md) | Z21 path, checklist |
