...
func NewRouter(cfg RouterConfig) http.Handler {
	...
	authH := NewAuthHandler(cfg.Auth, cfg.Layouts, cfg.Sudo, cfg.Audit, cfg.SecureCookie, cfg.Metrics, cfg.OAuth)
	...
	commandStationH.SetAllowedOrigins(cfg.AllowedOrigins)
	if cfg.DccBus != nil {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Group(func(r chi.Router) {
				...
				r.Get("/command-stations/scan/ws", commandStationH.ScanWS)
