...
type railboxRb23xxEp07Eu07FunctionSeed struct {
	num  uint8
	name string
	icon string
}
...
var railboxRb23xxEp07Eu07Functions = []railboxRb23xxEp07Eu07FunctionSeed{
	{0, "F0", "light"},
	{1, "Silnik", "engine"},
...
func seedRailboxRb23xxEp07Eu07TemplateUp(s *rel.Schema) {
	name := sqlLiteral(railboxRb23xxEp07Eu07TemplateName)
	...
	var parts []string
	for _, fn := range railboxRb23xxEp07Eu07Functions {
