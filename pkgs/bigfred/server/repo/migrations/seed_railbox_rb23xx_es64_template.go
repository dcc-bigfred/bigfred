...
type railboxRb23xxEs64FunctionSeed struct {
	num  uint8
	name string
	icon string
}
...
var railboxRb23xxEs64Functions = []railboxRb23xxEs64FunctionSeed{
...
func seedRailboxRb23xxEs64TemplateUp(s *rel.Schema) {
	name := sqlLiteral(railboxRb23xxEs64TemplateName)
	...
	var parts []string
	for _, fn := range railboxRb23xxEs64Functions {
