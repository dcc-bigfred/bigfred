...
const railboxRb23xxEp08TemplateName = "RB23xx / EP08"

type railboxRb23xxEp08FunctionSeed struct {
	num  uint8
	name string
	icon string
}

// railboxRb23xxEp08Functions is the F0–F28 mapping from the RailBOX
// RB23xx sound pack for EP08 locomotives.
var railboxRb23xxEp08Functions = []railboxRb23xxEp08FunctionSeed{
...
func seedRailboxRb23xxEp08TemplateUp(s *rel.Schema) {
	name := sqlLiteral(railboxRb23xxEp08TemplateName)
	...
	var parts []string
	for _, fn := range railboxRb23xxEp08Functions {
...
func seedRailboxRb23xxEp08TemplateDown(s *rel.Schema) {
	name := sqlLiteral(railboxRb23xxEp08TemplateName)
	s.Exec(rel.Raw(fmt.Sprintf(`
