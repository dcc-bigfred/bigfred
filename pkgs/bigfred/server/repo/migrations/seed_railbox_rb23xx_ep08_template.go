...
var railboxRb23xxEp08Functions = []templateFunctionSeed{
...
func seedRailboxRb23xxEp08TemplateUp(s *rel.Schema) {
	seedTemplateFunctions(s, railboxRb23xxEp08TemplateName, railboxRb23xxEp08Functions)
}

func seedRailboxRb23xxEp08TemplateDown(s *rel.Schema) {
	deleteTemplateSeed(s, railboxRb23xxEp08TemplateName)
}
