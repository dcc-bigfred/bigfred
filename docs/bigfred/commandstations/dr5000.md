...
[`loconet-adapter` §2–§6](../../loconet-adapter/README.md).
...
URI parser: [`pkgs/dcc-bus/station/driver.go`](../../../pkgs/dcc-bus/station/driver.go).
...
| Speed / direction | yes |
| Functions **F0–F8** | yes |
| Functions **F9+** | no (LocoNet driver limit) |
| State observation from handheld / other throttle | yes (shared LocoNet bus) |
...
Pi, firewall allowing **TCP 5550**. Same **F0–F8** limits as serial LocoNet.
...
[`loconet-adapter/01-overview`](../loconet-adapter/01-overview-and-architecture.md)).
...
| Document | Topic |
|----------|-------|
| [`loconet-adapter`](../../loconet-adapter/README.md) | Full DR5000 + Uhlenbrock bring-up |
| [`04-uhlenbrock-63120`](../../loconet-adapter/04-uhlenbrock-63120.md) | LNCV, udev, frame loss |
| [`05-bigfred-integration`](../../loconet-adapter/05-bigfred-integration.md) | Catalogue rows, daemon |
