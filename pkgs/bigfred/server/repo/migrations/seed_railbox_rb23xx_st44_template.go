...
type railboxRb23xxSt44FunctionSeed struct {
	num  uint8
	name string
	icon string
}
...
var railboxRb23xxSt44Functions = []railboxRb23xxSt44FunctionSeed{
...
func seedRailboxRb23xxSt44TemplateUp(s *rel.Schema) {
	name := sqlLiteral(railboxRb23xxSt44TemplateName)
	...
	var parts []string
	for _, fn := range railboxRb23xxSt44Functions {
