...
void i18n
  ...
  .init({
    ...
    defaultNS: "common",
    ns: ["common", "auth", "errors", "role", "home", "layout", "interlocking", "radio", "vehicle", "user", "sudo", "throttle", "commandStation", "diagnostics", "function", "trainAnnouncements", "audit", "rentals"],
    interpolation: {
