...
| `--poll-interval-ms` | uint | no | `0` (→ `750`) | State-feed polling cadence for drivers without push (Z21). Ignored when the driver supports `StateObserver` (LocoNet). See §7e.9. |
