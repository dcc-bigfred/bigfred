...
top-level section. The parent file [`../architecture.md`](../architecture.md)
is the thin entry point with the full table of contents.
...
11. [Authentication, Roles & Authorization](./10-authn-authz/README.md)
12. [API Keys & Built-in MCP Server](./11-api-keys-and-mcp.md)
13. [Makefile Additions](./12-makefile.md)
14. [Delivery Order (Milestones)](./13-delivery-order.md)
15. [Acceptance Criteria](./14-acceptance-criteria/README.md)
