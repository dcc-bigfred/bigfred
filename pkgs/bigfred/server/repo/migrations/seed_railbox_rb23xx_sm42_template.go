...
type railboxRb23xxSm42FunctionSeed struct {
	num  uint8
	name string
	icon string
}
...
var railboxRb23xxSm42Functions = []railboxRb23xxSm42FunctionSeed{
...
func seedRailboxRb23xxSm42TemplateUp(s *rel.Schema) {
	name := sqlLiteral(railboxRb23xxSm42TemplateName)
	...
	var parts []string
	for _, fn := range railboxRb23xxSm42Functions {
